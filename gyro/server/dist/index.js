...
const wsServer = new wsServer_1.WSServer(server);
// REST API endpoints
...
function startTestingLoop() {
    ...
    setInterval(async () => {
        try {
            ...
            const testDirection = buildingLocationService_1.BuildingLocationService.headingToCardinalDirection(testHeading);
...
function calculateAngleDifference(heading, bearing) {
