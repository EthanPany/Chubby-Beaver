...
class DirectionCalculator {
     ...
     */
    calculateConfidence(rotationRate, userAcceleration) {
        // Calculate magnitude of rotation
        const rotMagnitude = Math.sqrt(rotationRate.x ** 2 +
            rotationRate.y ** 2 +
            rotationRate.z ** 2);
        // Calculate magnitude of acceleration
        const accMagnitude = Math.sqrt(userAcceleration.x ** 2 +
     ...
     */
    processMotionData(eulerAngles, rotationRate, userAcceleration) {
